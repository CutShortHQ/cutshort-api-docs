...
`POST /invite-to-apply` sends a candidate an **invite to apply** to one of your jobs, with your custom message. This is the outreach step of the core loop: after searching and shortlisting, close the loop by inviting the best candidates to your posted job.
