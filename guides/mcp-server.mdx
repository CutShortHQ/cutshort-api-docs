...
<Frame caption="Cutshort MCP server in Claude Desktop (Settings → Developer)">
  <img
    src="/images/claude-desktop-mcp.png"
    alt="Claude Desktop Developer settings showing the cutshort local MCP server running with npx mcp-remote configuration"
